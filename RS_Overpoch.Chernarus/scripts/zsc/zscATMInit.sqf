...
ATMDialogWithdrawAmount = {
	...
	if (_amount > 99999999) exitWith {"You can not withdraw more than 99,999,999 coins at once." call dayz_rollingMessages};
...
ATMDialogDepositAmount = {
	...
	if (_amount > 99999999) exitWith {"You can not deposit more than 99,999,999 coins at once." call dayz_rollingMessages};
